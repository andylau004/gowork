...
// NewFromEnv is a helper function to create
// a new logger instance based on the environment.
// If "production" or "staging" is received as the arguemnt,
// the NewProduction function is called.
// Otherwise NewDevelopment is called.
func NewFromEnv(env string) *zap.Logger {
